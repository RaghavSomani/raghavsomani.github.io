...
1. [Meta-learning for Mixed Linear Regression](http://proceedings.mlr.press/v119/kong20a.html){:target="_blank" rel="noopener noreferrer"} at [ICML 2020](https://icml.cc/Conferences/2020){:target="_blank" rel="noopener noreferrer"}, and
2. [Robust Meta-learning for Mixed Linear Regression with Small Batches](https://papers.nips.cc/paper/2020/hash/3214a6d842cc69597f9edf26df552e43-Abstract.html){:target="_blank" rel="noopener noreferrer"} at [NeurIPS 2020](https://nips.cc/Conferences/2020){:target="_blank" rel="noopener noreferrer"}.