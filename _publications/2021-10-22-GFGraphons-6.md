...
![Gradient flow on a 24 node graph represented via evolution of adjacency matrices. The objective function is the homomorphism density of a 5-cycle.](https://raghavsomani.github.io/publications/files/GFGraphons.png){:class="img-responsive"}
