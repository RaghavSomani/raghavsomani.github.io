...
Currently, I am trying to analytically understand the limiting continuous as well as discrete training dynamics of arbitrary neural networks using the lens of optimal transport, limiting graph theory and algebra. Related topics in vicinity include gradient flow/descent on metric spaces, and optimization under over-parameterization. I also like learning mathematical Analysis, Geometry and theoretical Physics.
