...
excerpt: 'We study the distribution of stochastic gradient noise during training and observe that, for batch sizes $$256$$ and above, it is best described as Gaussian, at least in the early phases of training.'
date: 2019-10-01
...
The paper has been accepted at the [SEDL workshop](https://sites.google.com/view/sedl-neurips-2019/){:target="_blank" rel="noopener noreferrer"} at [NeurIPS 2019](https://nips.cc/Conferences/2019){:target="_blank" rel="noopener noreferrer"}.

Please find the below resources:
1. [ArXiv](https://arxiv.org/pdf/1910.09626.pdf){:target="_blank" rel="noopener noreferrer"}.
