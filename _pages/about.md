...
Hi, my name is Raghav Somani!<audio id="name_audio" src="\files\raghav_somani_hi.mp3" preload="auto"></audio><a class="fas fa-volume-up" onclick="document.getElementById('name_audio').play();"></a>
